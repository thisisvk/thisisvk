...
status      : "Building scalable systems, one pipeline at a time 🚀"
open_to     : "Collaborations | DevOps Consulting | Cloud Projects"
```
...
| 🏆 Achievement | 📊 Impact |
|:---|:---|
| ⚡ Pipeline Automation | Reduced deployment cycles by **60%+** |
| 🐳 Containerization at Scale | **10+ production services** on Docker + K8s |
| 🤖 Ops Automation | Saved **10+ hrs/week** via Python & Bash scripts |
| 📡 Observability | **99.9% uptime** with Prometheus + Grafana stack |
| ☁️ AWS Infrastructure | EC2, S3, IAM, VPC — zero environment incidents |
...
```bash
┌──(vivek㉿prod-server)-[~/experience]
└─$ journalctl --since "2023-04-01" | tail -20
```

```
● Orvion Tech                                          [Mar 2025 – Present]
  ├── DevOps Engineer
  ├── CI/CD via Jenkins + GitHub Actions → 60% faster deploys
  ├── 10+ apps containerized (Docker + K8s)
  └── AWS (EC2, S3, IAM, VPC) → 99.9% uptime maintained

● Himerose Private Limited                             [Sep 2023 – Feb 2025]
  ├── DevOps Engineer
  ├── Automated e-commerce release pipeline → 60%+ manual effort cut
  ├── Docker microservices → zero env-related production incidents
  └── Prometheus + Grafana monitoring stack built from scratch

● DigitalXperts                                        [Apr 2023 – Aug 2023]
  ├── Python Developer (Internship)
  ├── REST API development + backend services
  └── Foundation in clean code & engineering practices

[STATUS] Active — building, shipping, automating ✓
```

<img src="https://user-images.githubusercontent.com/73097560/115834477-dbab4500-a447-11eb-908a-139a6edaec5c.gif">

## `> watch -n 1 cat /proc/learning`
